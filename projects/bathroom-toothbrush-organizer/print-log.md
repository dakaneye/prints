...
- Wall style: smooth vertical reeding (sine-displaced perimeter), replacing the
  first pass's deep semicircular scallops, which read as spiky cusps and spiked
  at the corners. Reeding is wide-pitch / shallow; tune via `FLUTE_PITCH` and
